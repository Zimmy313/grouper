...
\section{Mathematical allocation models}\label{mathematical-allocation-models}
...
\section{\texorpdfstring{The \texttt{grouper} package}{The grouper package}}\label{the-grouper-package}
...
\section{Multi-role workload allocation in practice}\label{multi-role-workload-allocation-in-practice}
...
\subsection{Hyperparameter effectiveness}\label{hyperparameter-effectiveness}
