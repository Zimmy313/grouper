...
In the following walk through, we demostrate how the PhD work allocation model
...
while all other courses are set to `-99`.
...
c_sem <- 4
c(
  capacity_units = nrow(phd_students_ex001) * c_sem,
